...
```bash
psql -h /tmp/pgsocket -p 5433 -d postgres -c "CREATE USER registro_user WITH PASSWORD 'Redtigers_greta2009' CREATEDB SUPERUSER;"
...
- Password: Redtigers_greta2009
- Database: registro
- URL completo: postgresql://registro_user:Redtigers_greta2009@/registro?host=/tmp/pgsocket&port=5433
