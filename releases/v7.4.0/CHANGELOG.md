...
### Added
- Robustezza, isolamento multi-tenant, indici DB e ottimizzazioni performance

## [7.4.0] - 2026-09-24

### Added
- App Android nativa (APK), Convocazioni avanzate (box non convocati, filtri gruppo, PDF 1 pagina) e workflow Dev-First
